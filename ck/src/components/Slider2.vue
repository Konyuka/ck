                    ...
                    <div class="col-12">
                        <div class="slider-carousel owl-carousel">
                            ...
                            <div class="single-slider slider-bg-2 text-center">
                                <div class="slider-inner">
                                    <h3 class="h3-font-size">Design &amp; Layout Concepts</h3>
                                    <h5 class="h5-font-size">We pride ourselves on our ability to craft kitchen designs that
                                        are not only
                            ...
                            <div class="single-slider slider-bg-3 text-center">
                                <div class="slider-inner">
                                    <h3 class="h3-font-size">Choice of Equipment</h3>
                                    <h5 class="h5-font-size">We guide you in choosing the ideal equipment for your culinary
                                        space. We leverage
                                        our industry
