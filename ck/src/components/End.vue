<script setup scoped>
import Beone from '@/components/layouts/Beone.vue'
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="blog-carousel owl-carousel">
                            ...
                            <div class="single-blog-item">
                                <div class="single-blog-img">
                                    <img src="@/assets/beone/assets/img/blog_02.jpg" alt="">
                                    <span>October 25, 2017</span>
                                </div>
                                <div class="blog-content">
                                    <h5 class="post-heading"><a href="#">10 Tips for a Business Strong Start</a> </h5>
                            ...
                            <div class="single-blog-item">
                                <div class="single-blog-img">
                                    <img src="@/assets/beone/assets/img/blog_04.jpg" alt="">
                                    <span>October 25, 2017</span>
                                </div>
                                <div class="blog-content">
                                    <h5 class="post-heading"><a href="#">10 Tips for a Business Strong Start</a> </h5>
                ...
                <div class="brand-carousel owl-carousel">
                    <div class="brand-item">
                        <div class="brand-item-inner">
                            <a href="#"><img src="@/assets/beone/assets/img/brands/1.png" alt=""></a>
                        </div>
                    </div>
                    <div class="brand-item">
                        <div class="brand-item-inner">
                            <a href="#"><img src="@/assets/beone/assets/img/brands/2.png" alt=""></a>
                        </div>
                    </div>
                    <div class="brand-item">
                        <div class="brand-item-inner">
                            <a href="#"><img src="@/assets/beone/assets/img/brands/3.png" alt=""></a>
                        </div>
                    </div>
                    <div class="brand-item">
                        <div class="brand-item-inner">
                            <a href="#"><img src="@/assets/beone/assets/img/brands/4.png" alt=""></a>
                        </div>
                    </div>
                    <div class="brand-item">
                        <div class="brand-item-inner">
                            <a href="#"><img src="@/assets/beone/assets/img/brands/5.png" alt=""></a>
                        </div>
                    </div>
                    <div class="brand-item">
                        <div class="brand-item-inner">
                            <a href="#"><img src="@/assets/beone/assets/img/brands/6.png" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
