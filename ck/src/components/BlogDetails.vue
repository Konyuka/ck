        ...
        <div class="container ">
          <div class="row g-5">
            <div class="col-lg-8">
              <!-- Blog Detail Start -->
              <div class="mb-5">
                <img class="img-fluid w-100 rounded mb-5" src="@/assets/startup/img/blog-1.jpg" alt="">
              ...
              <div class="mb-5">
                ...
                <div class="d-flex mb-4">
                  <img src="@/assets/startup/img/user.jpg" class="img-fluid rounded" style="width: 45px; height: 45px;">
                  <div class="ps-3">
            ...
            <div class="col-lg-4">
              ...
              <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                ...
                <div class="d-flex rounded overflow-hidden mb-3">
                  <img class="img-fluid" src="@/assets/startup/img/blog-1.jpg" style="width: 100px; height: 100px; object-fit: cover;"
                    alt="">
                ...
                <div class="d-flex rounded overflow-hidden mb-3">
                  <img class="img-fluid" src="@/assets/startup/img/blog-2.jpg" style="width: 100px; height: 100px; object-fit: cover;"
                    alt="">
                  <a href="" class="h5 fw-semi-bold d-flex align-items-center bg-light px-3 mb-0">Lorem ipsum dolor sit
                    amet adipis elit
                  </a>
                ...
                <div class="d-flex rounded overflow-hidden mb-3">
                  <img class="img-fluid" src="@/assets/startup/img/blog-3.jpg" style="width: 100px; height: 100px; object-fit: cover;"
                    alt="">
                  <a href="" class="h5 fw-semi-bold d-flex align-items-center bg-light px-3 mb-0">Lorem ipsum dolor sit
                    amet adipis elit
                  </a>
              ...
              <!-- Image Start -->
              <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                <img src="@/assets/startup/img/blog-1.jpg" alt="" class="img-fluid rounded">
              </div>
              <!-- Image End -->
