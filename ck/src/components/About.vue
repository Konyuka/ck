                ...
                <div class="row g-5">
                    <div class="col-lg-12 py-10">
                        ...
                        <p class="mb-4" style="color: black;">
                            ...
                            clients,
                            especially first-time purchasers, lacked the knowledge and guidance required to navigate the
                            complexities of commercial kitchen design and equipment selection. We were determined to make a
                            difference.

                            <br> <br>

                            Together, we formed Commercial Kitchens Consultants with a singular mission: to empower our
                            clients
                            and ensure a seamless journey in creating their ideal commercial kitchens. We believe that no
                            client
                    ...
                    <!-- <div class="col-lg-5" style="min-height: 500px;">
                        <div class="position-relative h-100">
                            <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s"
                                src="@/assets/startup/img/about.jpg" style="object-fit: cover;">
                        </div>
                    </div> -->
                </div>
            </div>
